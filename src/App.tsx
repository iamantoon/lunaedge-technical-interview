            ...
            <form onSubmit={handleSubmit(onSubmit)} onClick={e => e.stopPropagation()} className='flex flex-col space-y-4 max-w-screen-sm mx-auto' autoComplete='off'>
                <div>
                    ...
                    <input 
                        ...
                        className='bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
                    />
                ...
                <button
                    ...
                    className={`text-white ${
                        ...
                        ? 'bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300'
