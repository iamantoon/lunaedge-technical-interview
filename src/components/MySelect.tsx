...
const MySelect = ({options, value, handleSelectOption, setFilter, selectedPokemons, isSelectVisible, setSelectVisible, setPopUpVisible, removePokemon}: ISelectProps) => {
