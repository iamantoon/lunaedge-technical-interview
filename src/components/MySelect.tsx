                ...
                <ul className={`absolute w-${width} overflow-y-auto scr`} style={{'height': 205}}>
                    {options.map((option) => (
                        <li
                            ...
                            className={`bg-gray-50 border p-3 rounded-none hover:bg-gray-100  cursor-pointer capitalize-first text-gray-900 ${labelSize} focus:ring-blue-500 focus:border-blue-500 block w-${width} dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                        >
                            {option.name}
                        </li>
                    ))}
